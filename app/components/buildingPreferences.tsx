      ...
      <View style={styles.panel}>
              ...
              <View key={day.day} style={styles.dayCard}>
                ...
                >
                  <View style={styles.dayTitleRow}>
                    ...
                    >
                      {day.enabled && <Check size={14} color={scheme.white} />}
                    </View>
                    <Text style={styles.dayTitle}>{day.day}</Text>
                  </View>

                  {day.enabled ? (
                    <ChevronRight size={18} color={scheme.muted} />
                  ) : null}
                </TouchableOpacity>
        ...
        <View style={styles.footerRow}>
          <TouchableOpacity style={styles.backButton} onPress={goBack}>
            <ChevronLeft size={16} color={scheme.subtext} />
      ...
      {showTopHeader && (
        ...
        >
          <TouchableOpacity style={styles.topHeaderButton} onPress={onCancel}>
            <ChevronLeft size={18} color={scheme.primaryDark} />
...
const buildingStyles = (COLORS: ThemeType) =>
  StyleSheet.create({
    container: {
      width: "100%",
      flex: 1,
