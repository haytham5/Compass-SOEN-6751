...
export const testReports: Report[] = [
  {
    ...
    timeline: [
        { action: "reported", by: "concordian", time: "09:30 AM" },
        { action: "upvoted", by: "user1@test.com", time: "09:45 AM" },
        { action: "upvoted", by: "user2@test.com", time: "10:00 AM" },
    ],
  ...
  },
  {
    ...
    timeline: [
        { action: "reported", by: "concordian", time: "11:00 AM" },
        { action: "resolved", by: "user3@test.com", time: "11:30 AM" },
    ],
    upvotedBy: [],
    isResolved: true,
  ...
  },
  {
    ...
    timeline: [
        ...
        { action: "verified", by: "security", time: "10:15 AM" },
        { action: "upvoted", by: "user1@test.com", time: "10:20 AM" },
    ],
  ...
  },
  {
    ...
    timeline: [
        ...
        { action: "verified", by: "security", time: "08:45 AM" },
        { action: "upvoted", by: "user1@test.com", time: "09:00 AM" },
        { action: "upvoted", by: "user2@test.com", time: "09:15 AM" },
        { action: "upvoted", by: "user3@test.com", time: "09:30 AM" },
    ],
  ...
  },
  {
    ...
    isVerifiedBySecurity: false,
    timeline: [
        { action: "reported", by: "admin", time: "09:00 AM" },
    ],
    upvotedBy: [],
    isResolved: false,
